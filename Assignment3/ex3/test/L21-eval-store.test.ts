...
describe('L21 Box Eval', () => {
    ...
    describe('Primitive Procedures', () => {
        ...
        it('evaluates "-"', () => {
            ...
            expect(evalParse("(- 2 1 1)")).to.deep.equal(makeOk(0));
            expect(evalParse("(- 2)")).to.deep.equal(makeOk(-2));
            expect(evalParse("(-)")).to.satisfy(isFailure);
        });
        ...
        it('evaluates "/"', () => {
            ...
            expect(evalParse("(/ 4 2 2)")).to.deep.equal(makeOk(1));
            expect(evalParse("(/ 4)")).to.deep.equal(makeOk(0.25));
            expect(evalParse("(/)")).to.satisfy(isFailure);
        });
